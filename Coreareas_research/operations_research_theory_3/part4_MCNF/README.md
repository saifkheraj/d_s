...
The constraint matrix is: $A = \begin{pmatrix} 2 & 3 \end{pmatrix}$
...
The constraint matrix is: $A = \begin{pmatrix} 1 & 1 \\ -1 & 0 \\ 0 & -1 \end{pmatrix}$
...
**When $\det(A) = 5$:**
$$A^{-1} = \frac{1}{5} \begin{pmatrix} d & -b \\ -c & a \end{pmatrix}$$
